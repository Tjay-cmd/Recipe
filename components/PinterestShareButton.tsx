...
export function PinterestShareButton({ url, imageUrl, description }: PinterestShareButtonProps) {
  function handlePinterestShare() {
    ...
    window.open(
      pinterestUrl,
      'pinterest-share',
      'width=750,height=550,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=1'
    )
  }
