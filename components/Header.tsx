      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 py-0">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/swipe" className="text-gray-700 hover:text-emerald-600 transition-colors font-medium">
              Swipe Mode
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 py-4 animate-in slide-in-from-top-2 duration-200">
            <nav className="flex flex-col space-y-4">
              ...
              <Link
                href="/swipe"
                className="text-gray-700 hover:text-emerald-600 transition-colors px-4 py-2 font-medium"
                onClick={() => setMobileMenuOpen(false)}
              >
                Swipe Mode
              </Link>
